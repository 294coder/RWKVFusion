...
path = (
    "/volsparse1/czh/exps/fcformer-bk/visualized_img/data_MIMO_SST_harvard_x8_ref.mat"
)
full_res = True if "unref" in path else False
dataset_type = "harvard_x8"
ratio = (
    4
    if dataset_type not in ["cave", "harvard"]
    else int(dataset_type.split("_")[-1][-1])
)
print("===================DATASET========================")
