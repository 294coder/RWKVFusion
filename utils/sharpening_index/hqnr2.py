...
if __name__ == "__main__":
    ...
    QNR_index, D_lambda, D_S, HQNR_map = indexes_evaluation_FS(
        I_F, I_MS_LR, I_PAN, L, th_values, I_MS, sensor, ratio, Qblocks_size, False
    )
    print(QNR_index)
