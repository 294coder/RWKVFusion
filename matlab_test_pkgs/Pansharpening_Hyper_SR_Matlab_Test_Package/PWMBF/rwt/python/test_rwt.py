...
class TestRWT(unittest.TestCase):
    ...
    def test_dwt_2d(self):
        ...
        y_corr = array(
            [
                [34.0000, -3.4641, 0.0000, -2.0000],
                [-13.8564, 0.0000, 0.0000, -2.0000],
                [-0.0000, 0.0000, -0.0000, -0.0000],
                [-8.0000, -8.0000, 0.0000, -0.0000],
            ]
        )
    ...
    def test_denoise_threshold_low(self):
        ...
        with_noise = signal + noise / 10
        h = daubcqf(6)[0]
        signal_denoised, subtracted_noise, actual_options = denoise(
            with_noise, h, 0, [1, 3.0, 0, 2, 0, 0]
        )
        signal_denoised_corr = array(
            [
                0.0187742354278351,
    ...
    def test_denoise_actual_thresh(self):
        ...
        h = daubcqf(6)[0]
        signal_denoised, subtracted_noise, actual_options = denoise(
            with_noise, h, 0, [0, 3.0, 0, 2, 0, 0.5]
        )
        signal_denoised_corr = array(
            [
                0.0607099183942295,
    ...
    def test_denoise_udwt_actual_thresh(self):
        ...
        h = daubcqf(6)[0]
        signal_denoised, subtracted_noise, actual_options = denoise(
            with_noise, h, 1, [0, 3.0, 0, 1, 0, 0.5]
        )
        signal_denoised_corr = array(
            [
                0.126244615385152,
